  ...
  return (
    ...
    >
      <div className="text-5xl bg-base-200 px-[5%] lg:max-w-2xl text-primary max-w-sm z-50 opacity-100 h-full flex flex-col justify-center  font-bold">
        ...
        <p className="text-xl font-normal my-5 text-black">
          You can find your beast working tools here. To select it, just scroll
          and find.We always ready to serve you with our best.
        </p>
        <Link to="/Inventory" className="btn btn-primary max-w-xs text-white">
          Get start
        </Link>
      </div>
    </div>
