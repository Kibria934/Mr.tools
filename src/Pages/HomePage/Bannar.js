...
const Bannar = () => {
  ...
  return (
    <div className="mt-16 h-[80vh]" style={{backgroundImage:`url(${banner1})`,opacity:'0.9',backgroundRepeat:'no-repeat',backgroundSize:'cover',backgroundPosition:'bottom'}}>
      <div className="text-5xl bg-base-200 px-[5%] lg:max-w-2xl text-primary max-w-sm z-50 opacity-100 h-full flex flex-col justify-center  font-bold">
        ...
        <Link  to='/tools' className="btn btn-primary max-w-xs text-white">Get start</Link>
      </div>
    </div>
  );
};
