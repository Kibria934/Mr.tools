...
const SingleReview = ({ review }) => {
  ...
  return (
    <div className={`mx-auto cursor-pointer mb-4 lg:w-11/12`}>
      <div class="card w-full rounded-xl hover:border-b-red-600 lg:min-h-[310px] max-h-[400px] bg-base-100 rounded-none ease-in duration-300 border-b-8  border text-primary shadow-xl">
        <div class="card-body flex lg:flex-row items-center ">
          <div class="avatar">
            <div class="w-24 border-2 mask mask-hexagon">
