...
const More = () => {
  ...
  return (
    <div className="food-section lg:w-[70vw] mx-auto">
     ...
     <div className="flex px-2 lg:flex-row grid gap-2 grid-cols-2 lg:grid-cols-3 flex-col justify-between">
     <WhyChose img={tools1} icon={<BsTruck />} head={"Fast Service"}>
      ...
      <WhyChose img={secret} icon={<VscGistSecret />} head={"Secrete your info"}>
        User information valuable for us. We keep their secret very highly. We use our best process to make it.
      </WhyChose>
      <WhyChose img={success} icon={<MdOutlinePayment />} head={"Easy payment"}>
       Our specialty is easy payment system. This is the way we can make satisfy our user.
      </WhyChose>
     </div>
    </div>
  );
